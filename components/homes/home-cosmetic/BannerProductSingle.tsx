...
const product = bannerProductSingleItems[0];
...
function BannerProductSingleInner() {
  ...
  return (
    <section className="flat-spacing">
      <div
        className={`banner-product-single style-2 section-image-zoom ${isZooming ? "zoom-active" : ""}`}
      >
              ...
              <div className="tf-product-info-wrap position-relative mt-lg-0">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  <div className="single-heading">
                    {product.category && (
                      <p className="detail-tag text-body-1 cl-text-2 mb-4">
                        {product.category}
                      </p>
                    )}
                    <Link
...
export default function BannerProductSingle() {
  ...
  return (
    <ProductProvider
      ...
      colors={[]}
      sizes={sizes}
      initialSize={sizes.find((s) => s.active)?.value || sizes[0]?.value}
    >

...
export default function AffiliateRegistrationSection() {
  ...
  return (
    <>
      ...
      <style>{`
        .afp-wrap  { display:flex; flex-wrap:wrap; min-height:100vh; }
        .afp-hero  { position:relative; width:100%; min-height:300px; flex-shrink:0; overflow:hidden; }
        ...
        @media(min-width:1024px){
          .afp-hero { width:42%; min-height:100vh; }
        }
      ...
      <div className="afp-wrap">
        ...
        <div className="afp-form">
          ...
          <div style={{ width:"100%", maxWidth:"500px" }}>
            ...
            {/* Benefits card */}
            <div style={{
              border:`1px solid #dde3ee`, borderRadius:"14px",
              ...
              {BENEFITS.map(({ label, value, bold }, i) => (
                <div key={label} style={{
                  ...
                  <span style={{
                    color:NAVY, fontWeight:600, fontSize:"0.82rem",
              ...
              <div style={{
                ...
                padding:"10px 18px", gap:"12px", background:"#fafcff",
              }}>
                <span style={{
                  color:NAVY, fontWeight:600, fontSize:"0.82rem",
                  width:"148px", flexShrink:0,
            ...
            {submitted ? (
              ...
              <form onSubmit={submit} noValidate style={{ display:"flex", flexDirection:"column", gap:"14px" }}>
                ...
                <p style={{
                  ...
                  <Link href="/login" style={{ color:NAVY, fontWeight:700 }}>
                    Log in
                  </Link>
                </p>
              </form>
